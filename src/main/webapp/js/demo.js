    ...
    Ext.create('Ext.container.Viewport',
        {
            ...
            items: [
                ...
                {
                    region: 'north',
                    html: '<div style="background: url(img/banner.jpg);background-size: 100%;height: 100%;"><div style="font-family:helvetica, arial, verdana, sans-serif;font-size:13px; position: absolute;top: 50%;transform: translateY(-50%);"><strong><span style="color:#b0b0b0;font-size:16px;font-family:&quot;">&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMPES-精准教学管理系统</span></strong></div><div style="display:inline;float:right;"><a href=javascript:changePassword()  style="color: #b0b0b0">修改密码</a><font color="#b0b0b0">&nbsp&nbsp|&nbsp&nbsp</font><a href=javascript:loginOut()  style="color: #b0b0b0">安全退出</a></div><div style="float:right;" id="clock" ></div><div style="float:right;color: #b0b0b0" id="userName" ></div></div>',
