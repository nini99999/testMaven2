...
<script type="text/javascript">
    ...
    function operateFormatter(value, row, index) {
        ...
        return [
            '<a href="javascript:void(0)" title="编辑学校信息">',
            '<i class="glyphicon glyphicon-pencil" onclick="queryEschoolList()"></i>',
            '</a>',
...
// 回调函数，接受服务器端返回给客户端的值，即result值
    ...
    function addEschool() {
        ...
        params.schoolno = schoolno.value;
        params.schoolname = schoolname.value;

        $.ajax({

            url: "/eschool/addEshool",
...
<div id="bs_toolbar">
    ...
    <button class="btn btn-primary" type="button" onclick="queryEschoolList();">
        <span class="glyphicon glyphicon-eye-open"></span> 查询学校信息
    </button>
    <!-- 按钮触发模态框 -->
    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">
        <span class="glyphicon glyphicon-plus-sign"></span> 添加新记录
    </button>
    <button class="btn btn-primary" type="button" onclick="delEschool();">
        <span class="glyphicon glyphicon-minus-sign"></span> 删除选中记录
    </button>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                学校编码：<input id="schoolno" name="schoolno" class="btn-default"></input>
                学校名称：<input id="schoolname" name="schoolname" class="btn-default"></input>

            </div>
            <div class="modal-footer">

                <button class="btn btn-primary" type="button" onclick="addEschool();">
...
<div id="bs_t" style="float: none;display: block;margin-left: auto;margin-right: auto;width: 90%">
    <table class="table table-striped" width="80%" id="ds_table" align="center" data-url="/eschool/viewEschoolList"
           striped="true"
        ...
        <tr>
            ...
            <th data-field="schoolname" data-align="center" data-sortable="true">学校名称</th>
